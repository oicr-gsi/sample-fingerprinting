        ...
        try {
           if (getProperty("input_files") == null) {
            ...
            if (getProperty("genotypes") == null) {
                Logger.getLogger(FingerprintCollectorWorkflow.class.getName()).log(Level.SEVERE, "genotypes (vcf files) is not set, we need these to calculate similarity/generate genotypes");
                return (null);
            } else {
            ...
            if (getProperty("check_points") == null) {
                Logger.getLogger(FingerprintCollectorWorkflow.class.getName()).log(Level.SEVERE, "check_points (checkpoints) is not set, we need it to generate a report");
                return (null);
            } else {
